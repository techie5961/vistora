...
@section('main')
     ...
     <section class="w-full column g-10">
         <form action="{{ url('admins/post/music/streaming/upload/song/process') }}" method="POST" onsubmit="PostRequest(event,this,Added)" style="border:1px solid var(--rgt-01)" action="" class="w-full bg-light br-10 p-20 column g-10">
           @push('js')
               <script class="js">
         ...
         @endpush
            ...
            <div class="column w-full g-5">
                ...
                <label class="cont h-150 pointer banner column align-center justify-center">
                    <span>TAP TO UPLOAD</span>
                    <span class="opacity-07">JPG, PNG, WEBP(Max: 5MB)</span>
                    <input onchange="IMGChanged(this)" name="banner" accept="image/*" type="file" class="inp display-none input required">
                <img src="" alt="">
                </label>
            </div>
            @push('js')
            ...
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="audio" accept=".mp3, .wav, .m4a, .aac, .ogg" type="file" class="inp input required">
                </div>
            </div>
            {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="name" placeholder="E.g With You" type="text" class="inp input required">
                </div>
            </div>
             {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="artist" placeholder="E.g Davido ft Omah Lay" type="text" class="inp input required">
                </div>
            </div>
             {{-- new input --}}
            <div class="column w-full g-5">
                ...
                <div class="cont">
                    <input name="reward" placeholder="E.g {{ $currency }}2,000" type="number" class="inp input required">
                </div>
            </div>
            ...
            {{-- submit btn --}}
            <button class="post">Add Track</button>
