...
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32">
  <g fill="currentColor">
    <path d="m26,2H6c-2.206,0-4,1.794-4,4v20c0,2.206,1.794,4,4,4h20c2.206,0,4-1.794,4-4V6c0-2.206-1.794-4-4-4Zm-5,16l-5-4-5,4V4h10v14Z" stroke-width="0" fill="currentColor"></path>
  </g>
</svg>
            </div>
        ...
        {{-- loop --}}
          <div class="grid pc-grid-2 place-center g-10 w-full">
            ...
            <div style="border:1px solid var(--rgt-01)" class="w-full br-primary bg-light p-15px column g-5px">
                {{-- new row --}}
                <div style="border-bottom:1px dashed var(--rgt-01);padding-bottom:10px;" class="row align-center g-10 w-full space-between">
                    <div class="column g-5">
                        <div class="row align-center g-5px">
                            <img src="{{ asset('tasks/categories/'.$data->icon.'') }}" alt="" class="h-40px no-select no-shrink">
                ...
                <div class="row align-center w-full space-between g-10px">
                    <div class="column g-5">
                        ...
                        <strong class="font-weight-900">{{ $data->platform }}</strong>
                    </div>
                      <div style="text-align:end;align-items:flex-end" class="column g-5">
                        <small>Category Earning</small>
                        <strong class="font-weight-900">&#8358;{{ number_format($data->earning,2) }}</strong>
                    </div>
                </div>
