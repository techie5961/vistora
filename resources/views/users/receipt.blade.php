...
{{-- receipt body --}}
{{-- new group --}}
<div class="border-element column p-15px br-15px g-10px align-center text-align-center">
...
<div class="column align-center justify-center g-5">
    <span>Amount</span>
    <strong style="color:{{ $data->class == 'credit' ? 'rgb(0,255,0)' : 'red' }};font-size:2rem;font-weight:900;" class="title {{ $data->class == 'credit' ? 'c-green' : 'c-red' }}">{{ $data->class == 'credit' ? '+' : '-' }}{{ $currency }}{{ $data->amount }}</strong>
</div>
</div>
</div>
{{-- new group --}}
