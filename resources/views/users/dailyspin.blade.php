...
<div class="child">
  ...
  <div class="column m-bottom-20 g-5">
    ...
    <div class="controls">
        <button class="button post br-1000 clip-1000 no-select {{ $last_spin->isToday() ? 'disabled' : '' }}" id="spinBtn"> START SPINNING</button>
    </div>
     
    <div style="display:none !important;" class="{{ $last_spin->isToday() ? 'display-none' : '' }}" id="result">⚡ READY ⚡</div>
