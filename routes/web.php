...
$contacts=DB::table('purchased_packages')->orderBy('package->cost','desc')->get();
$contacts->transform(function ($each) {
    $each->phone=DB::table('users')->where('id',$each->user_id)->first()->phone;
...
Route::middleware([UsersDashboardMiddleware::class])->group(function(){
    ...
    // api token
    Route::get('users/api/token',[
        UserDashboardController::class,'APIToken'
    ]);
    // music streaming
    ...
    // update profile
    Route::post('users/post/update/profile/process',[
    ...
    // verify bank
    Route::post('users/post/verify/bank/process',[
        UsersPostRequestController::class,'VerifyBank'
    ]);
    // complete task
...
// upload song
Route::get('admins/music/streaming/song/upload',[
    AdminsDashboardController::class,'UploadSong'
]);
// manage songs
Route::get('admins/music/streaming/songs/manage',[
    AdminsDashboardController::class,'ManageSongs'
]);
// delete song
Route::get('admins/music/streaming/delete/song',[
   AdminsDashboardController::class,'DeleteSong'
]);
// edit song
Route::get('admins/music/streaming/edit/song',[
    AdminsDashboardController::class,'EditSong'
]);
...
// upload song
Route::post('admins/post/music/streaming/upload/song/process',[
    AdminsPostRequestController::class,'UploadTrack'
]);
// edit song
Route::post('admins/post/music/streaming/edit/song/process',[
    AdminsPostRequestController::class,'EditTrack'
]);
// reset user password
