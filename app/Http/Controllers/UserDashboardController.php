...
class UserDashboardController extends Controller
{
    ...
    public function Dashboard(){
       ...
       $total_withdrawals=DB::table('transactions')->where('type','withdrawal')->where('status','success')->where('user_id',Auth::guard('users')->user()->id)->count();
    ...
    public function Transactions(){
        ...
        if(request()->has('class')){
            $transactions=$transactions->where('class',request('class'));
        }
    ...
    public function DailyTasks(){
        ...
        $tasks=DB::table('tasks')->where('status','active')->whereColumn('completed','<','slots')->whereNotIn('id',function($q){
